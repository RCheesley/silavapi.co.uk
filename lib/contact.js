 ...
 * edge and in Node.
 */
import { isCyrillicHeavy, looksLikeListSpam } from './spam.js';
 ...
 * predominantly-Cyrillic text, or a "add me to your list / newsletter" request.
...
export function looksLikeSpamContent(fields = {}) {
  ...
  // Predominantly-Cyrillic text on an English-language site, or an imperative
  // "add me to your list / newsletter" request, is spam.
