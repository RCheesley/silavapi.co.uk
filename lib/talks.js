...
/** Presentation rows whose talk has the given format (e.g. "Keynote"). */
export function byFormat(presentations, format) {
  return (presentations || []).filter(
    (p) => p.talk && p.talk.data && p.talk.data.format === format
  );
}
