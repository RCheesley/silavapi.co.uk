 ...
 * content-type articles. No JS, no lightbox: just a responsive grid of figures,
 * each image carrying its migrated alt text (and an optional visible caption).
 */
 ...
 * @returns {string} inline HTML for a <ul> figure grid, or '' when empty
 */
