...
tags:
  ...
  - 'Community'
resources:
  - label: 'Mautic becomes an independent open source project'
    url: https://mau.tc/independence
  - label: 'Resource Management Initiative'
    url: https://mau.tc/resource-management
  - label: 'Data privacy initiative'
    url: https://mau.tc/data-privacy-initiative
  - label: 'UX/UI Initiative'
    url: https://mau.tc/ux-ui-initiative
  - label: 'Contribute to Mautic'
    url: https://mau.tc/contribute
  - label: 'Mautic Council'
    url: https://mau.tc/council
  - label: 'Become a member of Mautic'
    url: https://mau.tc/membership
  - label: 'Trials Early Adopter list'
    url: https://mau.tc/trials-ea
  - label: 'Mautic becomes a Digital Public Good'
    url: https://mau.tc/dpg
  - label: 'Volunteer for Mautic Conference Global 2024'
    url: https://mau.tc/mcg24-volunteer
source: https://speaking.ruthcheesley.co.uk/HVklhJ/the-mautic-update-february-2024
---
