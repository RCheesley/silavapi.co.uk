---
title: 'My first long distance race - Endure24 Reading'
date: 2022-07-15
category: 'Being bendy'
image: '/assets/img/blog/running-endure24-night-lap.jpg'
imageAlt: 'Photo of Ruth running at dawn with a headtorch under an illuminated arch saying ''More is in you''.'
imageCaption: 'Photos by Sportagraf'
excerpt: 'This weekend after a culmination of nearly a year''s training, I completed my first ever marathon - and indeed ultramarathon - race at Endure24 Reading. A…'
sourceUrl: '/blog/health-and-fitness/my-first-long-distance-race-endure24-reading'
---
...
_Obviously_ with such short distances up to the point where I signed up, I had a lot of work to do!

For about 6 months, I trained by increasing the distance that I was hitting with my longer runs, and working hard in my PT sessions on the muscle groups that you need to run - posterior chain, core, and legs! I based the training on the 50k 'just finish' ultramarathon plan from [marathonhandbook.com](https://marathonhandbook.com/trainingplans/50k-training-plan-just-finish/)  which I adapted slightly to take into account the other gym-based classes I did. You can take a look at my outline [here](https://docs.google.com/spreadsheets/d/1jVQh0DCk8eO4LFMH0tkFtK_jPDL1HYugWwhTqVcqSr0/edit?usp=sharing). I also highlighted when, based on the mileage, I would need to be looking at replacing my shoes.
...
It also became apparent in these sessions that I needed a different approach to training, with more focus on _how_ I was running, rather than just the distance.

## 80/20 training

At this point I came across the training plans from [MyProCoach](https://www.myprocoach.net), which are delivered through the [TrainingPeaks](https://www.trainingpeaks.com) app, synchronising directly to your Garmin device telling you precisely what to do, what heart rate and pace zones you should be in, and more importantly, completely tailored to your own fitness with regular fitness tests.
...
My longest run in training was just over 20 miles, with 6.5 hours of running over very challenging terrain into a 25 mph headwind, and although it was 10 miles short of what I had set as my goal, I figured _nothing_ could be as bad as the conditions on that day!
...
![A photo of Ruth, Viryamati and Ruth's mum on the side of the course. Ruth has a headtorch on and her mum is holding her previous lap's empty water bottle.](/assets/img/blog/the-dream-team.jpg)
...
Absolutely you need to have a solid aerobic base, good proactive foot care (read the [Fixing your Feet](https://amzn.to/3OaniiW)\* book, if you haven't already - it's the distance runners bible!), and take care of your body so that you don't get injured, but without a doubt the mental toughness is what will keep you going when everything hurts, there's another hill in front of you and you are feeling miserable in the middle of the night!

{% tweetable "Physical fitness gets you to the start line, mental toughness gets you to the finish line.", "", "" %}
...
![Photo of a laminated sign saying 'Hi I'm Ruth, running solo, 7 laps completed, 0 laps to go with 'Goal achieved' and 'Last lap' written in red pen and vegan runners logos on the top.](/assets/img/blog/20220620_221853.jpg)
...
![Ruth crossing the finish line at Endure24 with her hands raised in the air, dressed as a rainbow unicorn with a tutu, tail and headband with luminous rainbow leg warmers.](/assets/img/blog/finish-line-endure24-2022.png)
