---
title: 'Five things I''ve learned through running multilingual online conferences in our open source project'
date: 2023-06-29
category: 'Open source'
image: '/assets/img/blog/multilingual-events/translation-g67c6ab1b5_1280.jpg'
imageAlt: 'A photo from above of lots of brick-shaped flags of different nations'
imageCaption: 'Image by Gino Crescoli from Pixabay'
excerpt: 'Like many Brits, English is the only language I speak fluently. I speak schoolgirl French, a bit of Welsh and a few words in German and Dutch. I''m…'
sourceUrl: '/blog/open-source/five-things-ive-learned-through-running-multilingual-online-conferences-in-our-open-source-project'
---
...
Our [first ever event in 2020](https://mauticon.mautic.org/archive/global/2020), at the height of the covid-19 pandemic, had seven languages represented: English, French, German, Spanish, Portuguese, Japanese and Italian.  Nowadays we generally have around 4-5 languages in our conferences.
...
Our first events used a tool called [Veertly](https://www.veertly.com/virtual-conferences), and more recently we are using [Airmeet](https://www.airmeet.com/hub/use-case/conference-summits/). In both tools, we were able to create multiple rooms which ran simultaneously alongside each other, which meant that we could have an English track running at the same time as a Spanish and German track.  
...
We used [Sessionize](https://www.sessionize.com) as our tool for managing our Call for Speakers, displaying our schedule and speakers on the website, and with Veertly, embedding the schedule into the event and the individual rooms themselves (before they had an agenda feature).  
