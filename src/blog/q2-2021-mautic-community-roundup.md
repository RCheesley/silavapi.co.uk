---
title: 'Q2 2021 Mautic Community Roundup'
date: 2021-07-01
category: 'Mautic'
image: '/assets/img/joomlart/article/00e7056ec788d5b42162a6c13dbba43c.jpg'
imageCaption: 'Photo by Daniel Lerman on Unsplash'
excerpt: 'It hardly seems like three months have passed since the last roundup report on activity within the Mautic Community, but a lot has happened since then! Read on for the latest updates…'
sourceUrl: '/blog/mautic/q2-2021-mautic-community-roundup'
---
...
Last quarter we [launched](https://www.mautic.org/blog/community/announcing-mautic-community-partners-program) the [Mautic Community Partners Program](https://www.mautic.org/mautic-community-partners) with five partners being eligible at the launch of the programme.
...
A big thank you to the sponsors who have supported us this quarter on [Github Sponsors](https://github.com/sponsors/mautic) or [Open Collective](https://opencollective.com/mautic):
...
We have also added an infrastructure supporters section on our [sponsors page](https://www.mautic.org/sponsors), to highlight the organisations who are providing us with tools for free or at a reduced price which help us to develop Mautic and our community.
...
We have established [projects](https://opencollective.com/mautic/projects) for each of the key initiatives and for our community teams who have budgeted line items. You will see these listed on o[https://opencollective.com/mautic/projects](https://opencollective.com/mautic/projects).
...
There is currently an issue which is blocking the release process - the team are working on resolving this so that we can make the Mautic 4 Release Candidate release. After this is launched we will make the General Availability release following community testing. Follow [this forum post](https://forum.mautic.org/t/getting-ready-for-mautic-4-all-details-timelines/18692) for updates.
...
These are outlined in the announcement here: [https://www.mautic.org/blog/community/updates-mautic-community-release-process](https://www.mautic.org/blog/community/updates-mautic-community-release-process) 
...
We are in the process of re-consenting all existing contacts from our old instance, but if you would rather not wait please do join our mailing lists here: [https://www.mautic.org/community/get-involved/mailing-lists](https://www.mautic.org/community/get-involved/mailing-lists) 
...
Mautic was selected to be one of the 56 open source organisations taking part in the first round of the [FundOSS](https://fundoss.org/) pilot - an innovative approach to raising funds for open source projects.

A huge thank you to everybody who supported us during the two-week funding round - we raised [$1,411 from 52 donors](https://fundoss.org/collective/mautic) which was matched with $3,621 from the $75,000 fund. This money (minus transaction fees) has already been transferred to our Open Collective.

### New Mautic Meetup group

We are excited to share that we have a new Mautic Meetup starting in [València, Spain](https://www.meetup.com/mautic-meetup-valencia/). Organised by Julio Roldos and Joan Serra, we’re really looking forward to their first meetup being a great success!
...
Over the last 90 days, our most active contributors (based on the number of [conversations](https://docs.savannahhq.com/pages/conversations/)) have been:
...
![Chart showing active, new and returning members](https://lh4.googleusercontent.com/_iGLDUJVgqrLxk7GXQTQC5gAB_EThtqfI5tneqd9SP5V1qdMImVc6IAm9A1Z78Au3z9P3RBr_d0ErSI_Q0_3U0pUGsct5GC1XXJyhFChe6lWWEdsrPzgTvLehyljGBWlU7_-RWKm)
...
Some great collaboration happening across the community this quarter resulting in several projects coming to completion and a wonderful two days at Mautic Conference Global. There is much to do in the coming quarter, so please do think about getting involved! Join us on Slack at [https://mautic.org/slack](https://mautic.org/slack) and head over to #Community where we can help you find where to get started with contributing!
