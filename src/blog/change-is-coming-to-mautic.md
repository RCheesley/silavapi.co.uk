---
title: 'Change is coming to Mautic'
date: 2023-04-18
category: 'Mautic'
tags:
  - 'mautic'
  ...
  - 'governance'
  - 'acquia'
image: '/assets/img/blog/2023/04/time-for-a-change-g30ba07334_1920.jpg'
imageAlt: 'A photo of wooden word tiles spelling out ''time for change'' on a wooden surface at an angle, with a blurred black and white background'
imageCaption: 'Image by Alexa from Pixabay'
excerpt: 'Some exciting changes are coming to Mautic - learn more in my blog post!…'
sourceUrl: '/blog/mautic/change-is-coming-to-mautic'
---

Mautic has grown quite a bit since we first implemented the Mautic Community Governance Model in 2019. At our first ever [Community Summit](https://www.mautic.org/blog/community/first-mautic-community-summit-a-great-success) in Amsterdam that year, if you had told me that we would have increased our contributions tenfold within the next three years, I’d have had a hard time believing you. 
...
Acquia provided us with seed funding that gives us a cushion financially. This will allow me to continue in this role to focus on growth, employed by the community. To ensure sustainability, however, we must focus on developing our financial base. Currently, it costs us in the region of $20-30,000 per year to run the project. You can view the full breakdown of spending on our [Open Collective](https://opencollective.com/mautic).
...
Going forward we will be following the principles of the Open Startup model so expertly used by our Community Partners, [Friendly](https://friendly.ch/en/open), to share with you our financial status, growth against targets and how things are going. This will be posted on mautic.org and on our Open Collective each month.
...
-   [Mautic - Open Collective](https://opencollective.com/mautic)
-   [Mautic - GitHub Sponsors](https://github.com/sponsors/mautic)
