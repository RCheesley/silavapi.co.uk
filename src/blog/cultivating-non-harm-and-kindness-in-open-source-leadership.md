---
title: 'Cultivating non-harm and kindness in Open Source leadership'
date: 2025-05-15
category: 'Buddhism'
image: '/assets/img/blog/2025/group-round-diamonds-texture-closeup-3d-illustration.jpg'
imageAlt: 'Close up photo of round diamonds'
excerpt: 'In my last post, I explored the Four Samgrahavastus – ancient Buddhist principles for unifying a community that I''ve found to be super relevant to leading…'
sourceUrl: '/blog/buddhism/cultivating-non-harm-and-kindness-in-open-source-leadership'
---

In my last post, I explored the [Four Samgrahavastus](/blog/four-ancient-principles-every-open-source-leader-can-benefit-from-implementing/) – ancient Buddhist principles for unifying a community that I've found to be super relevant to leading open source projects like Mautic. The positive response encouraged me to delve deeper into Buddhist ethics for practical wisdom applicable to our unique challenges in the world of open source.
...
Conversely, the positive aspect involves cultivating _mettā_ - not romantic love, but what Sangharakshita described as a ‘**cherishing, protecting, maturing love**’. It's about actively wishing well for others and operating from a 'love mode' based on appreciative solidarity, rather than a 'power mode' focused on control and dominance.
...
When working with a precept, it asks us to examine the _intention_ behind our communication and not just the _actual words_ that come out of our mouth or through the keybord.
...
There have certainly been times when I've communicated more harshly than I intended under pressure, or failed to fully consider the impact of a decision on someone's workload or well-being. Recognising these moments isn't about self-flagellation; it's an opportunity to step back and appreciate the reality of cause and effect, making amends where possible, and recommitting to the practice. Understanding _why_ I might slip - tiredness, stress, attachment to an outcome - helps me address the root cause.
...
The first precept, the diamond pillar of non-harm and kindness, is _not_ an optional add-on for community health; it _is_ the essential infrastructure. Just as the [Four Samgrahavastus](/blog/four-ancient-principles-every-open-source-leader-can-benefit-from-implementing/) provide tools for unification, this precept lays the groundwork upon which everything else is built.
...
_What are your thoughts? How do you see the principles of non-harm and kindness playing out in your open source experiences? What practices help you cultivate them?_
