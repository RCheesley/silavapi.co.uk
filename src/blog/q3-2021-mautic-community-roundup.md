---
title: 'Q3 2021 Mautic Community Roundup'
date: 2021-10-01
category: 'Mautic'
image: '/assets/img/joomlart/article/2a14beb1aee2d71c6fecb12f25c690f7.jpg'
imageCaption: 'Image by Arek Socha from Pixabay'
excerpt: 'It hardly seems that it was a year ago we were releasing Mautic 3.0 release, but here we are just over a year later, and Mautic 4 has been released!…'
sourceUrl: '/blog/mautic/q3-2021-mautic-community-roundup'
---
...
It has been another busy quarter as the Product Team worked hard to get [Mautic 4.0](https://www.mautic.org/blog/community/mautic-4-standing-tall) released. It was delayed beyond our target release date due to some bugs that were identified during the testing of the Release Candidate, and a lack of community testers.

The first bug fix release was made on Monday, [4.0.1](https://github.com/mautic/mautic/releases/tag/4.0.1), with nine bugs fixed focusing on forms, in accordance with our [new release process](https://www.mautic.org/blog/community/updates-mautic-community-release-process).

We also back-ported some security fixes to Mautic 3, which will receive security fixes for six months after the 4.0 release is made. Please update to [3.3.4](https://github.com/mautic/mautic/releases/tag/3.3.4) if you are not yet ready to update to 4.0.

If you use Mautic and would like to help us to test bug fixes and new features, please do let us know in the #t-product channel on Slack. We can help you get set up to test which will make a big difference! Get an invite to join Slack at [mautic.org/slack](https://www.mautic.org/slack).
...
Read more about the RFP process [here](https://www.mautic.org/blog/community/how-do-ideas-become-features-mautic), and check out the opportunities accepting proposals [here](https://github.com/mautic/mautic/discussions/categories/requests-for-proposals-rfps).
...
-   [Nick Veenhof](https://www.mautic.org/blog/community/community-spotlight-nick-veenhof), who led the Composer Initiative
-   [Nikola Nedić](https://www.mautic.org/blog/community/community-spotlight-nikola-nedic), who developed the user interface for the Tag Management feature
-   [Adrian Schimpf](https://www.mautic.org/blog/community/community-spotlight-adrian-schimpf), who led the Builders Initiative
...
The call for speakers is [currently open](https://mauticon.mautic.org/call-speakers) - please submit your sessions before the 10th October. Speakers will have their travel and accommodation covered by the event budget.

There are also several opportunities to promote your organization and support the community as a [sponsor](https://mauticon.mautic.org/become-sponsor), from our tiered sponsorships to bag drops and lanyard sponsors.

Tickets will be going on sale imminently - keep an eye out on social media and email!

### New meetup group

We are excited to share that we have a new Mautic Meetup starting in [Ghent, Belgium](https://www.meetup.com/mautic-meetup-ghent/). Organised by Nick Veenhof and team from Dropsolid, we’re really looking forward to their [first meetup](https://www.meetup.com/mautic-meetup-ghent/events/281126361/) being a great success!

If you think you’d like to start a Mautic Meetup group in your local area, please take a look at the guidance in our [Community Handbook](https://contribute.mautic.org/community-team/meetup-guidelines) and drop us a message in #t-community on Slack.
...
The Education Team has kicked off several projects this quarter, including the task of transitioning our [developer documentation](https://developer.mautic.org/) from Slate over to Read the Docs, and updating it during the process. This will allow us not only to localise the documentation, but also to version it - thus when we have major releases we can maintain multiple versions of the developer documentation.
...
There are several trademark infringement cases which are being actively pursued, several have now been escalated to enforcement action. This is an important aspect of maintaining our trademark and ensuring that anybody using the Mautic name and brand are doing so in line with the [Trademark Policy](https://contribute.mautic.org/policies/trademark).
...
Read more about what is defined as a contribution [here](https://docs.savannahhq.com/pages/contributions/).
...
There are so many opportunities to get involved with helping Mautic grow and improve, regardless of your skills or experience level - please do consider setting aside a few hours a week to give something back, and/or contributing to the community through our [GitHub Sponsors](https://github.com/sponsors/mautic) and [Open Collective](https://opencollective.com/mautic). Every contribution really does help us to move forward together as a project and a community. Thank you!
