---
title: 'Four ancient principles every open source leader can benefit from implementing'
date: 2025-03-28
category: 'Community'
image: '/assets/img/blog/2025/wooden-table-top-view-hands-protecting-wooden-figures-people.jpg'
imageAlt: 'A wooden table with six wooden figures of people in a circle appearing to hold hands. There''s a person with two hands cupping around one side of the circle of figures in a supportive looking stance.'
excerpt: 'Open source communities face unique challenges. Distributed teams, volunteer contributors, competing priorities, and the constant balance between…'
sourceUrl: '/blog/community-management/four-ancient-principles-every-open-source-leader-can-benefit-from-implementing'
---
...
I've spoken quite a bit about how we try to [recognise, reward and celebrate](https://speaking.ruthcheesley.co.uk/uIAJxk/establishing-an-incentivised-partners-programme-in-an-open-source-project) such contributions from both individuals and organisations at Mautic, because often they're hidden from view and people don't always feel that their generosity is recognised.
