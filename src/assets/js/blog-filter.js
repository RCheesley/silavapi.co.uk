 ...
 * Filters the already-rendered post cards by category chip + search text, and
 * announces the result count politely. Without JS, every post is shown.
 */
(function () {
